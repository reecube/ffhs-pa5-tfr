...
public class ExportModelTest extends TestingBase {
    ...
    public void testExportModel() throws Exception {
        ...
        final boolean deleted = true;        //TODO: @Barbara, Wie kann ich das testen?
        ...
        final Date expectedExportdate = new Date(System.currentTimeMillis()); //TODO: Wird das überaupt irgendwo zugewiesen?
